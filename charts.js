...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var filteredSample = samplesArray.filter(obj => obj.id == sample);
    ...
    var sample_values = firstSample.sample_values.map((value) => parseInt(value));
    ...
    var bubbleData = {
      ...
      hoverinfo: otuLabel,
      mode: "markers",
      marker: {size: sample_values, color: otuID, colorscale: "Jet"}
    };
